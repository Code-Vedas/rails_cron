...
RSpec.describe Kaal::SchedulerFileLoader do
  ...
  it 'raises for duplicate keys inside YAML' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /Duplicate job keys/)
  end
  ...
  it 'raises on unknown placeholders' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /Unknown placeholder/)
  end
  ...
  it 'raises on malformed placeholders' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /Malformed placeholder/)
  end
  ...
  it 'raises when placeholders are used in hash keys' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /Placeholders are not supported in hash keys/)
  end
  ...
  it 'raises when job_class does not inherit from ActiveJob::Base' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /must inherit from ActiveJob::Base/)
  end

  it 'raises for malformed YAML syntax' do
    write_scheduler("test:\n  jobs:\n    - key: bad\n      cron: '* * * * *'\n      job_class: [\n")

    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /Failed to parse scheduler YAML/)
  end
  ...
  it 'raises for ERB evaluation errors with file context' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /Failed to evaluate scheduler ERB/)
  end
  ...
  it 'raises for blank key with payload context' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /Job key cannot be blank/)
  end
  ...
  it 'raises when YAML root is not a hash' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /root to be a mapping/)
  end
  ...
  it 'raises when defaults section is not a mapping' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /'defaults' section to be a mapping/)
  end
  ...
  it 'raises when defaults.jobs is not an array' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /defaults.jobs/)
  end
  ...
  it 'raises when a jobs entry is not a mapping' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /jobs entry must be a mapping/)
  end
  ...
  it 'raises when env jobs is not an array' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /test.jobs/)
  end
  ...
  it 'raises for invalid cron expressions' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /Invalid cron expression/)
  end
  ...
  it 'raises when cron is blank' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /Job cron cannot be blank/)
  end
  ...
  it 'raises for non-hash metadata' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /metadata must be a mapping/)
  end
  ...
  it 'raises for non-array args' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /args must be an array/)
  end
  ...
  it 'raises for non-hash kwargs' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /kwargs must be a mapping/)
  end
  ...
  it 'raises for non-string queue' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /queue must be a string/)
  end
  ...
  it 'raises when enabled is not a boolean' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /enabled must be a boolean/)
  end
  ...
  it 'raises when job_class constant is missing' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /Unknown job_class/)
  end
  ...
  it 'raises when callback kwargs resolve to a non-hash at runtime' do
    ...
    end.to raise_error(Kaal::SchedulerConfigError, /kwargs for scheduler job 'job:runtime_bad_kwargs_type' must be a mapping/)
  end
  ...
  it 'raises on conflict when policy is error' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /Scheduler key conflict/)
  end
  ...
  it 'raises when scheduler file is missing and policy is error' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /Scheduler file not found/)
  end
  ...
  it 'raises for unsupported conflict policy when a source conflict exists' do
    ...
    expect { build_loader.load }.to raise_error(Kaal::SchedulerConfigError, /Unsupported scheduler_conflict_policy/)
  end
  ...
  it 'restores previous registry entry when rolling back and key is now unregistered' do
    old_callback = ->(fire_time:, idempotency_key:) { [fire_time, idempotency_key] }
    existing_registry_entry = Kaal::Registry::Entry.new(
