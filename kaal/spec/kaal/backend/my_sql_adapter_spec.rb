...
RSpec.describe Kaal::Backend::MySQLAdapter do
  ...
  describe '#acquire' do
    ...
    it 'shortens lock names longer than 64 characters using hash-based approach' do
      ...
      allow(Kaal).to receive(:logger).and_return(logger_double)
    ...
    it 'raises LockAdapterError on database failure' do
      ...
      end.to raise_error(Kaal::Backend::LockAdapterError, /MySQL acquire failed/)
    end
  ...
  describe '#release' do
    ...
    it 'raises LockAdapterError on database failure' do
      ...
      end.to raise_error(Kaal::Backend::LockAdapterError, /MySQL release failed/)
    end
  end
  ...
  describe 'lock name length limit' do
    ...
    context 'when Kaal.logger is nil' do
